...
RSpec.describe Api::ReservationsController, type: :controller do
  ...
  describe 'GET #index' do
    it 'returns a list of reservations' do
      reservation1 = Reservation.create(city: 'New York', date: Date.today, number_of_person: 2, section: section, user: user)
      reservation2 = Reservation.create(city: 'Los Angeles', date: Date.tomorrow, number_of_person: 4, section: section, user: user)
  ...
  describe 'GET #show' do
    it 'returns a specific reservation' do
      reservation = Reservation.create(city: 'New York', date: Date.today, number_of_person: 2, section: section, user: user)
